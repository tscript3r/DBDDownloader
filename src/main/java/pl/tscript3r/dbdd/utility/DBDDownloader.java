...
public class DBDDownloader {
	...
	private final Integer CONNECTION_TIMEOUT = 15;
	
	private final String STATUS_MENU_FILE = "Status";
	private final String CONFIG_MENU = "Configuration Page";
	...
	private Boolean validateInputData() {
		...
		if (!isValidPath(savePath) || !isExistingPath(savePath)) {
